...
async function main() {
  ...
  if (coverImage) {
    coverImage = coverImage.replace(/wifirst-tech-blog\.appspot\.com/g, 'wifirst-tech-blog.firebasestorage.app');
    await doc.ref.update({ coverImage });
    console.log('Article coverImage URL updated');
  }
}
