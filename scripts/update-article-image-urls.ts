...
async function main() {
  ...
  // Replace bucket name in URLs
  content = content.replace(/wifirst-tech-blog\.appspot\.com/g, 'wifirst-tech-blog.firebasestorage.app');

  await doc.ref.update({ content });
  console.log('Article image URLs updated');
}
